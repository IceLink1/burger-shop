...
let burger= document.querySelector(".X")
let nav = document.querySelector('.navb')
let nohave =document.querySelector('.nohave')
let nohave2 =document.querySelector('.nohave2')
let navBurgers = document.querySelectorAll(".nav_main_two")
burger.addEventListener('click',()=>{
    nav.classList.toggle("heig")
})
...
//     if(prom == ''||prom == null){
//         prom= prompt("ismingizni kiriting: ")
//         e--;
//     }
//     if(prom !==''){
//         alert(`xush kelibsiz ${prom}!!!`) 
//     }
// }
...
inp2.addEventListener('keyup', (e) => {
    ...
    if (ul2.textContent =='') {
        nohave2.textContent=`Sorry we dont have : ${inp2.value}`
    }
    if (ul2.textContent !=='') {
        nohave2.textContent=''
    }
...
inp1.addEventListener('keyup', (e) => {
    ...
    if (ul1.textContent =='') {
        nohave.textContent=`Sorry we dont have : ${inp1.value}`
    }
    if (ul1.textContent !=='') {
        nohave.textContent=''
    }
